                ...
                <div class="mb-1 w-full">
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2">Keranjang</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                    ...
                    <div class="sm:flex">
                        ...
                        <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                            <form action="<?= BASEURL; ?>/borrow/cart_checkout" method="POST">
                                    ...
                                    foreach ($data['pagination']['paginatedData'] as $datum) : ?>
                                        <tr class="hover:bg-gray-100">
                                            <td class="p-4 w-4 lg:p-5">
                                                <div class="flex items-center">
                                                    <input type="checkbox" name="id_cart[]"  value="<?= $datum['id_cart']; ?>" id="checkbox-1" aria-describedby="checkbox-1" class="w-5 h-5 rounded border-gray-300 focus:ring-0 checked:bg-dark-900">
                                                    <input type="hidden" name="noref" value="rizm-<?= rand(1, 9999999) ?>">
                                                    <input type="hidden" name="id_buku[]" value="<?= $datum['id_buku'] ?>">
                                                    <input type="hidden" name="id_users[]" value="<?= $datum['id_users'] ?>">
                                            ...
                                            <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                                <button type="button" data-modal-toggle="delete-cart-modal" data-id="<?= $datum['id_cart'] ?>" class="modalHapus-Cart inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-gradient-to-br from-red-400 to-red-600 rounded-lg shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform">
            ...
            <div class="items-center p-4 my-4 mx-4 bg-white rounded-2xl shadow-xl shadow-gray-200 sm:flex sm:justify-between">
                ...
                <div class="flex items-center space-x-3">
                    <?php if ($data['pagination']['currentPage'] > 1) : ?>
                        <a href="<?= BASEURL; ?>/borrow/cart/<?= ($data['pagination']['currentPage'] - 1) ?>" class="inline-flex flex-1 justify-center items-center py-2 px-3 text-sm font-medium text-center text-white bg-gradient-to-br from-dark-700 to-dark-900 rounded-lg shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform">
