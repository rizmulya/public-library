<div class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 h-modal sm:h-full" id="borrowed-modal">
                <div class="relative px-4 w-full max-w-2xl h-full md:h-auto">
                    <div class="relative bg-white rounded-2xl shadow-lg">
                        <div class="flex justify-between items-start p-5 rounded-t border-b">
                            ...
                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-2xl text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="borrowed-modal">
                        ...
                        <div class="p-6 space-y-6">
                            <form action="<?= BASEURL; ?>/borrow/borrowed_edit" method="POST">
                                ...
                                <div class="items-center p-6 rounded-b border-t border-gray-200">
                                    <input type="hidden" name="id" id="id_checkout">
