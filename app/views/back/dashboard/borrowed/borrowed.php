...
<div class="flex overflow-hidden bg-white pt-16">
    ...
    <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
        <main>
                ...
                <div class="mb-1 w-full">
                    ...
                    <div class="sm:flex">
                        <div class=" items-center mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0">
                            <form class="lg:pr-3" action="<?= BASEURL; ?>/borrow/borrowed" method="POST">
                            ...
                            <div class="flex pl-0 mt-3 space-x-1 sm:pl-2 sm:mt-0 ">
                                ...
                                <a href="<?= BASEURL; ?>/borrow/borrowed" class="inline-flex justify-center p-1 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100">
                        ...
                        <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                                <!-- <button data-tooltip-target="statusz" type="button" class="inline-flex justify-center items-center py-2 px-3 w-1/2 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 hover:scale-[1.02] transition-transform sm:w-auto">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            <td class="p-4 w-4 lg:p-5">
                                                <div class="flex items-center">
                                                    ...
                                                    <input type="hidden" name="noref" value="rizm-<?= rand(1, 9999999) ?>">
                                                    <input type="hidden" name="id_buku[]" value="<?= $join['id'] ?>">
                                                    <input type="hidden" name="id_users[]" value="<?= $join['id'] ?>">
                                                    <input type="hidden" name="qty[]" value="<?= $datum['qty'] ?>">
                                            ...
                                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5"><?= $join['nama'] ?></td>
                                            <td class="flex items-center p-4 mr-12 space-x-3 whitespace-nowrap lg:p-5 lg:mr-0">
                                                <img class="w-8 h-10 rounded" src="<?= BASEURL; ?>/img/books/<?=  $join['gambar']; ?>" alt="Neil Sims avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                                    <div class="text-base font-semibold text-gray-900 mr-3"><?= $join['judul']; ?></div>
                                                </div>
                                            </td>
                                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5"><?= $join['noref'] ?></td>
                                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5"><?= $join['tgl'] ?></td>
                                            ...
                                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5">
                                                <?php if($datum['status'] == 'Terkonfirmasi') : ?>
                                                    <button type="button" data-modal-toggle="borrowed-dikembalikan" data-id="<?= $datum['id_checkout'] ?>" class="modalUbah-Dikembalikan inline-flex items-center py-2 px-3 text-sm font-medium text-center text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 hover:text-gray-900 hover:scale-[1.02] transition-all">
                                                ...
                                                <?php else : ?>
                                                    <button type="button" data-modal-toggle="borrowed-modal" data-id="<?= $datum['id_checkout'] ?>" class="modalUbah-Borrowed inline-flex items-center py-2 px-3 text-sm font-medium text-center text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 hover:text-gray-900 hover:scale-[1.02] transition-all">
                                                        <svg class="mr-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"></path></svg>
                                                    </button>
                                                <?php endif; ?>
                                                <button type="button" data-modal-toggle="delete-borrowed-modal" data-id="<?= $datum['id_checkout'] ?>" class="modalHapus-Borrowed inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-gradient-to-br from-red-400 to-red-600 rounded-lg shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform">
            ...
            <?php include"borrowed_delete.php"; ?>
            <?php include"borrowed_dikembalikan.php"; ?>
            <?php include"borrowed_edit.php"; ?>
    </main>
  </div>
</div>
