...
!(function () {
  ...
  var o = window.document,
    ...
    M = {
      ...
      "issue-opened": { heights: { 16: { width: 16, path: '<path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>' } } },
      "mark-github": {
        heights: {
          16: {
            width: 16,
    ...
    F = function (o, e) {
      ...
      if (!(t.push(e) > 1)) {
        ...
        if (d) {
          ...
          var c = f(i.document)("script", { async: !0, src: o + (-1 !== o.indexOf("?") ? "&" : "?") + "callback=_" }),
            l = function () {
              i._ && i._({ meta: {} });
            };
    ...
    L = function (o, e, t) {
      ...
      var i = "large" === p(e["data-size"]),
        d = r("a", { className: "btn", href: e.href, rel: "noopener", target: "_blank", title: e.title || void 0, "aria-label": e["aria-label"] || void 0, innerHTML: Z(e["data-icon"], i ? 16 : 14) + "&nbsp;" }, [
          r("span", {}, [e["data-text"] || ""]),
        ]),
      ...
      if (
        ((((u === c || u === "gist." + c) && "archive" === h[3]) || (u === c && "releases" === h[3] && ("download" === h[4] || ("latest" === h[4] && "download" === h[5]))) || u === "codeload." + c) && (d.target = "_top"),
    ...
    T = function (e, r) {
      if (null != e && null != r)
        if (
          ...
          var n = h("iframe", { src: "javascript:0", title: e.title || void 0, allowtransparency: !0, scrolling: "no", frameBorder: 0 });
