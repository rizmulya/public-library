  ...
  return (function () {
    ...
    var t = {
        ...
        853: function (t, e, i) {
            ...
            return i && ("html" === A(i) || ("body" === A(i) && "static" === R(i).position))
              ...
              : i ||
                  (function (t) {
                    ...
                    var i = K(t);
                    for (P(i) && (i = i.host); j(i) && ["html", "body"].indexOf(A(i)) < 0; ) {
                      var n = R(i);
                      if (
                        "none" !== n.transform ||
                        "none" !== n.perspective ||
          ...
          function et(t) {
            ...
            if (h) {
              var A = X(i),
                C = "clientHeight",
                j = "clientWidth";
              if ((A === T(i) && "static" !== R((A = N(i))).position && "absolute" === p && ((C = "scrollHeight"), (j = "scrollWidth")), c === n || ((c === s || c === r) && l === d)))
                (x = o), (b -= (v && A === k && k.visualViewport ? k.visualViewport.height : A[C]) - a.height), (b *= f ? 1 : -1);
            ...
            return (
              ...
              (b = D.y),
              f
                ? Object.assign({}, S, (((P = {})[x] = L ? "0" : ""), (P[O] = E ? "0" : ""), (P.transform = (k.devicePixelRatio || 1) <= 1 ? "translate(" + y + "px, " + b + "px)" : "translate3d(" + y + "px, " + b + "px, 0)"), P))
                : Object.assign({}, S, (((e = {})[x] = L ? b + "px" : ""), (e[O] = E ? y + "px" : ""), (e.transform = ""), e))
            );
          }
          var it = {
              name: "computeStyles",
          ...
          function pt(t) {
            return ["html", "body", "#document"].indexOf(A(t)) >= 0 ? t.ownerDocument.body : j(t) && ut(t) ? t : pt(K(t));
          }
          function ft(t, e) {
            var i;
            void 0 === e && (e = []);
              ...
              : ht(
                  (function (t) {
                    var e,
                      ...
                      a = -n.scrollLeft + dt(t),
                      c = -n.scrollTop;
                    return "rtl" === R(o || i).direction && (a += I(i.clientWidth, o ? o.clientWidth : 0) - r), { width: r, height: s, x: a, y: c };
                  })(N(t))
                );
          }
          function vt(t, e, i, n) {
            var o =
                "clippingParents" === e
                  ? (function (t) {
                      var e = ft(K(t)),
                        i = ["absolute", "fixed"].indexOf(R(t).position) >= 0 && j(t) ? X(t) : t;
                      return C(i)
                        ? e.filter(function (t) {
          ...
          function yt(t, e) {
            ...
            var i = e,
              ...
              A = t.rects.popper,
              T = t.elements[E ? k : b],
              j = vt(C(T) ? T : T.contextElement || N(t.elements.popper), v, y, d),
              P = V(t.elements.reference),
              S = mt({ reference: P, element: A, strategy: "absolute", placement: a }),
              D = ht(Object.assign({}, A, S)),
              I = b === f ? D : P,
              M = { top: j.top - I.top + x.top, bottom: I.bottom - j.bottom + x.bottom, left: j.left - I.left + x.left, right: I.right - j.right + x.right },
                        ...
                        D(i) === a
                          ? (function (t, e) {
                              ...
                              var h = f.reduce(function (e, i) {
                                return (e[i] = yt(t, { placement: i, boundary: o, rootBoundary: r, padding: s })[D(i)]), e;
                              }, {});
                              return Object.keys(h).sort(function (t, e) {
                                return h[t] - h[e];
                              });
                            })(e, { placement: i, boundary: _, rootBoundary: b, padding: y, flipVariations: L, allowedAutoPlacements: O })
                          : i
                      );
                    }, []),
                    C = e.rects.reference,
          ...
          var Ot = {
            ...
            fn: function (t) {
              var e = t.state,
                i = t.name;
              e.modifiersData[i] = mt({ reference: e.rects.reference, element: e.rects.popper, strategy: "absolute", placement: e.placement });
            },
            data: {},
          };
          var xt = {
            ...
            fn: function (t) {
              var e = t.state,
                ...
                P = "number" == typeof j ? { mainAxis: j, altAxis: j } : Object.assign({ mainAxis: 0, altAxis: 0 }, j),
              ...
              if (A) {
                if (d) {
                  var H,
                    ...
                    it = tt[V],
                    nt = G(0, T[z], Z[z]),
                    ot = O ? T[z] / 2 - K - nt - et - P.mainAxis : U - nt - et - P.mainAxis,
                    rt = O ? -T[z] / 2 + K + nt + it + P.mainAxis : J + nt + it + P.mainAxis,
          ...
          function kt(t, e, i) {
            ...
            return (
              (r || (!r && !i)) &&
                (("body" !== A(e) || ut(a)) && (l = (n = e) !== T(n) && j(n) ? { scrollLeft: (o = n).scrollLeft, scrollTop: o.scrollTop } : lt(n)), j(e) ? (((d = V(e, !0)).x += e.clientLeft), (d.y += e.clientTop)) : a && (d.x = dt(a))),
          ...
          function jt(t) {
            ...
            return function (t, e, i) {
              ...
              var o,
                s,
                a = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, Tt, r), modifiersData: {}, elements: { reference: t, popper: e }, attributes: {}, styles: {} },
                c = [],
                l = !1,
                d = {
                  state: a,
                  setOptions: function (i) {
                    ...
                    u(), (a.options = Object.assign({}, r, a.options, o)), (a.scrollParents = { reference: C(t) ? ft(t) : t.contextElement ? ft(t.contextElement) : [], popper: ft(e) });
                    var s = (function (t) {
                      var e = At(t);
                  ...
                  forceUpdate: function () {
                    if (!l) {
                      var t = a.elements,
                        ...
                        i = t.popper;
                      if (Ct(e, i)) {
                        (a.rects = { reference: kt(e, X(i), "fixed" === a.options.strategy), popper: W(i) }),
                          (a.reset = !1),
          ...
          function r() {
            document.querySelectorAll("[data-accordion]").forEach(function (t) {
              ...
              t.querySelectorAll("[data-accordion-target]").forEach(function (e) {
                ...
                new o(s, { alwaysOpen: "open" === e, activeClasses: i || n.activeClasses, inactiveClasses: r || n.inactiveClasses });
            });
          }
            ...
            o = (function () {
              function t(t, e) {
                void 0 === t && (t = []),
                  void 0 === e && (e = n),
                  (this._items = t),
                  (this._options = i(i(i({}, n), e), { indicators: i(i({}, n.indicators), e.indicators) })),
            ...
            document.querySelectorAll("[data-carousel]").forEach(function (t) {
              ...
              t.querySelectorAll("[data-carousel-item]").length &&
                Array.from(t.querySelectorAll("[data-carousel-item]")).map(function (t, e) {
                  r.push({ position: e, el: t }), "active" === t.getAttribute("data-carousel-item") && (s = e);
                });
              var a = [];
              ...
              var c = new o(r, { defaultPosition: s, indicators: { items: a }, interval: e || n.interval });
              i && c.cycle();
        ...
        922: function (t, e) {
          ...
          var n = { onCollapse: function () {}, onExpand: function () {}, onToggle: function () {} },
            o = (function () {
              function t(t, e, o) {
        ...
        556: function (t, e) {
          ...
          var n = { triggerType: "hover", onShow: function () {}, onHide: function () {}, onToggle: function () {} },
            o = (function () {
              function t(t, e, o, r) {
                void 0 === t && (t = null),
                  void 0 === e && (e = null),
        ...
        791: function (t, e) {
          ...
          var n = { transition: "transition-opacity", duration: 300, timing: "ease-out", onHide: function () {} },
            o = (function () {
              function t(t, e, o) {
          ...
          var n = {
            ...
            o = (function () {
              ...
              return (
                (t.prototype._init = function () {
                  var t = this;
                  this._targetEl && (this._targetEl.setAttribute("aria-hidden", "true"), this._targetEl.classList.add("transition-transform")),
            ...
            document.querySelectorAll("[data-drawer-target]").forEach(function (e) {
              ...
              if (s) {
                ...
                r(i, t) ||
                  t.push({
                    id: i,
                    object: new o(s, { placement: a || n.placement, bodyScrolling: c ? "true" === c : n.bodyScrolling, backdrop: l ? "true" === l : n.backdrop, edge: d ? "true" === d : n.edge, edgeOffset: u || n.edgeOffset }),
                  });
        ...
        316: function (t, e, i) {
          ...
          var r = i(853),
            s = { placement: "bottom", triggerType: "click", offsetSkidding: 0, offsetDistance: 10, delay: 300, ignoreClickOutsideClass: !1, onShow: function () {}, onHide: function () {}, onToggle: function () {} },
            a = (function () {
              function t(t, e, i) {
                void 0 === t && (t = null),
                  void 0 === e && (e = null),
        ...
        16: function (t, e) {
          ...
          var n = { placement: "center", backdropClasses: "bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-40", backdrop: "dynamic", closable: !0, onHide: function () {}, onShow: function () {}, onToggle: function () {} },
            o = (function () {
              function t(t, e) {
          ...
          function s() {
            ...
            document.querySelectorAll("[data-modal-target]").forEach(function (e) {
              ...
              if (s) {
                ...
                r(i, t) || t.push({ id: i, object: new o(s, { placement: a || n.placement, backdrop: c || n.backdrop }) });
              ...
              document.querySelectorAll("[data-modal-toggle]").forEach(function (e) {
                ...
                if (s) {
                  var a = s.getAttribute("data-modal-placement"),
                    c = s.getAttribute("data-modal-backdrop"),
                    l = r(i, t);
                  l || ((l = { id: i, object: new o(s, { placement: a || n.placement, backdrop: c || n.backdrop }) }), t.push(l)),
                    e.addEventListener("click", function () {
                      l.object.toggle();
                    });
          ...
          function c() {
            document.querySelectorAll("[data-popover-target]").forEach(function (t) {
              ...
              if (i) {
                ...
                new a(i, t, { placement: o || s.placement, offset: r ? parseInt(r) : s.offset, triggerType: n || s.triggerType });
